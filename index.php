...
<head>
	...
	<link href='//fonts.googleapis.com/css?family=Bitter:400,400italic,700&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
			...
			<div class="col-xs-12">
				...
				<div class="trow trow-full trow-top site-main-trow">
					...
					<?php if (isset($_GET['template']) && $_GET['template'] != 'homepage') { ?>
						<?php include('templates/components/site-aside.php') ?>
					<?php } ?>
